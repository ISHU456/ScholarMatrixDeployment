...
const DailyAttendance = () => {
    ...
    const fetchStatus = async () => {
        try {
            ...
            const res = await axios.get(`${import.meta.env.VITE_API_URL || 'https://scholarmatrixdeploymentserver.onrender.com'}/api/attendance/daily/status`, {
    ...
    const submitAttendance = async () => {
        ...
        try {
            ...
            const url = mode === 'entry' 
                ? `${import.meta.env.VITE_API_URL || 'https://scholarmatrixdeploymentserver.onrender.com'}/api/attendance/daily/entry` 
                : `${import.meta.env.VITE_API_URL || 'https://scholarmatrixdeploymentserver.onrender.com'}/api/attendance/daily/exit`;
