...
const ResultVerification = () => {
  ...
  const handleReject = async () => {
    ...
    try {
      await axios.post(`${import.meta.env.VITE_API_URL || 'http://localhost:5001'}/api/results/reject`, { courseId, semester, academicYear, reason: rejectionReason }, { headers: { Authorization: `Bearer ${user.token}` } });
