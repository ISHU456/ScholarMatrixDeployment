...
const Courses = () => {
    ...
    const fetchCourses = async () => {
      ...
      try {
        ...
        const [coursesRes, deptsRes] = await Promise.all([
          axios.get(`${import.meta.env.VITE_API_URL || 'https://scholarmatrixdeploymentserver.onrender.com'}/api/courses`, {
  ...
  useEffect(() => {
    const fetchAllCounts = async () => {
      ...
      for (const course of courses) {
        try {
          const res = await axios.get(`${import.meta.env.VITE_API_URL || 'https://scholarmatrixdeploymentserver.onrender.com'}/api/auth/course-activity/${course.code}`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setShowModal(false);
      const res = await axios.get(`${import.meta.env.VITE_API_URL || 'https://scholarmatrixdeploymentserver.onrender.com'}/api/courses`, {
