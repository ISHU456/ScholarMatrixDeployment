...
const AssignmentInterface = ({ assignment, user, isTeacher, onBack, fetchAssignments }) => {
    ...
    const fetchSubmissions = async () => {
        try {
            const res = await axios.get(`${import.meta.env.VITE_API_URL || 'https://scholarmatrixdeploymentserver.onrender.com'}/api/assignments/submissions/${assignment._id}`, {
    ...
    const handleDeleteSubmission = async (subId) => {
        ...
        try {
            await axios.delete(`${import.meta.env.VITE_API_URL || 'https://scholarmatrixdeploymentserver.onrender.com'}/api/assignments/submissions/${subId}`, {
                headers: { Authorization: `Bearer ${user.token}` }
            });
            fetchSubmissions();
