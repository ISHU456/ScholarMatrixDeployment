  ...
  const testimonials = [
    {
      ...
      content: "Scholar Node has revolutionized how I teach. The AI doubt resolver alone has increased student engagement by 300%. My students are more confident and perform better on assessments.",
      rating: 5,
      avatar: "SJ",
    ...
    },
    {
      ...
      content: "We've implemented Scholar Node across 50+ courses, and the results are outstanding. The platform is scalable, secure, and the support team is exceptional. A game-changer for higher education.",
      rating: 5,
      avatar: "ER",
        ...
        <div className="container mx-auto relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          <div className="flex flex-col items-start text-left max-w-2xl">
            ...
            <p className="text-lg md:text-xl text-gray-600 dark:text-gray-400 mb-12 font-medium leading-relaxed">
              Experience education like never before. Scholar Node integrates unparalleled AI capabilities with seamless live collaboration to craft a personalized curriculum tailored uniquely to your academic success.
            </p>
        ...
        <div className="container mx-auto">
          <div className="text-center max-w-4xl mx-auto mb-20">
            ...
            <p className="text-base md:text-lg text-gray-600 dark:text-gray-400 font-medium">
              Join thousands of satisfied students and educators who have transformed their learning experience with Scholar Node
            </p>
          </div>
        ...
        <div className="container mx-auto">
          <div className="text-center">
            ...
            <p className="text-base md:text-lg text-gray-600 dark:text-gray-400 mb-12 max-w-2xl mx-auto font-medium">
              Join thousands of students already accelerating their academic success with Scholar Node
            </p>
