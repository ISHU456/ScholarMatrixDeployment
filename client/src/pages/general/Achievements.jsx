...
const Achievements = () => {
  ...
  const badgeInventory = [
    ...
    },
    {
      ...
      meaning: 'Marks a significant milestone in your learning journey as you progress through the Scholar Node ranks.',
      icon: Rocket,
          ...
          <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-white/80 font-medium mb-10 leading-relaxed">
                Experience points (XP) are awarded for every productive action you take in Scholar Node. 
