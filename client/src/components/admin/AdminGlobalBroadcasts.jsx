...
const AdminGlobalBroadcasts = ({ user }) => {
    ...
    const fetchBroadcasts = async () => {
        try {
            const res = await axios.get(`${import.meta.env.VITE_API_URL || 'https://scholarmatrixdeploymentserver.onrender.com'}/api/admin/broadcasts`, {
    ...
    const handleSend = async (e) => {
        ...
        setIsSaving(true);
        try {
            await axios.post(`${import.meta.env.VITE_API_URL || 'https://scholarmatrixdeploymentserver.onrender.com'}/api/admin/broadcasts`, formData, {
                headers: { Authorization: `Bearer ${user.token}` }
            });
