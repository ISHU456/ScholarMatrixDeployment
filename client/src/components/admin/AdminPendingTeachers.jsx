...
const AdminPendingTeachers = ({ user }) => {
    ...
    const fetchPendingTeachers = async () => {
        try {
            setLoading(true);
            const res = await axios.get(`${import.meta.env.VITE_API_URL || 'https://scholarmatrixdeploymentserver.onrender.com'}/api/admin/teachers/pending`, {
    ...
    const handleAuthorize = async (id) => {
        try {
            setAuthorizing(id);
            await axios.post(`${import.meta.env.VITE_API_URL || 'https://scholarmatrixdeploymentserver.onrender.com'}/api/admin/teachers/pending/${id}/authorize`, {}, {
                headers: { Authorization: `Bearer ${user.token}` }
            });
            // Remove from list
