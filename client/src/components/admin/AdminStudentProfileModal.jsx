...
const AdminStudentProfileModal = ({ studentId, user, onClose }) => {
        ...
        const fetchData = async () => {
            try {
                const endpoint = (user.role === 'admin' || user.role === 'hod') 
                    ? `${import.meta.env.VITE_API_URL || 'https://scholarmatrixdeployment-api.onrender.com'}/api/admin/students/${studentId}`
                    : `${import.meta.env.VITE_API_URL || 'https://scholarmatrixdeployment-api.onrender.com'}/api/auth/student-profile/${studentId}`;
    ...
    const handleSave = async () => {
        setIsSaving(true);
        try {
            await axios.put(`${import.meta.env.VITE_API_URL || 'https://scholarmatrixdeployment-api.onrender.com'}/api/admin/students/${studentId}/enrollment`, {
                semester,
                department,
                section,
                rollNumber,
